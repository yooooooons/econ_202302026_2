...
sell_normal_profit_ratio = 0.045   # Normal Selling 판매시 이익율
...
ratio_sell_ema_mid_chg_state = 0.999   # 권장 판매조건이 만족 안된 상태에서, ema_long 비율이 어느정도 미만이 되면 자동 판매 되게끔 (매수시의 상승추세가 꺾였다고 판단)
